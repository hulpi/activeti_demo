...
public class DemoDataConfiguration {
  ...
  protected void initDemoUsers() {
    ...
    createUser("checker1", "checker1", "The Great", "1", "gonzo@activiti.org", 
            "org/activiti/explorer/images/gonzo.jpg",
            Arrays.asList("user", "checker"),
            null);
    
    createUser("checker2", "checker2", "The Great", "1", "gonzo@activiti.org", 
            "org/activiti/explorer/images/kermit.jpg",
            Arrays.asList("user", "checker"),
            null);
    
    createUser("auditor1", "auditor1", "The Great", "1", "gonzo@activiti.org", 
            "org/activiti/explorer/images/gonzo.jpg",
            Arrays.asList("user", "auditor"),
            null);
    
    createUser("auditor2", "auditor2", "The Great", "1", "gonzo@activiti.org", 
            "org/activiti/explorer/images/gonzo.jpg",
            Arrays.asList("user", "checker", "auditor"),
            null);
    
    createUser("approver1", "approver1", "Bear", "1", "bigman@activiti.org", 
            "org/activiti/explorer/images/fozzie.jpg",
            Arrays.asList("user", "approver"),
            null);
    
    createUser("admin", "admin", "The Frog", "admin", "admin@activiti.org", 
            "org/activiti/explorer/images/kermit.jpg",
            Arrays.asList("management", "sales", "marketing", "engineering", "user", "admin", "checker", "auditor", "approver"),
            Arrays.asList("birthDate", "10-10-1955", "jobTitle", "Muppet", "location", "Hollywoord",
                          "phone", "+123456789", "twitterName", "alfresco", "skype", "activiti_kermit_frog"));
  }
